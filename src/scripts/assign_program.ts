...
let currentSelectedTemplate: string | null = null;

function loadTemplate(btnElement: HTMLElement, templateName: string): void {
    ...
    if (!previewContainer || !exercises) return;
