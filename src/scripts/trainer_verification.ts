 ...
 */
function setupImagePreview(inputId: string, previewId: string, iconId: string, removeBtnId: string): void {
    const fileInput = document.getElementById(inputId) as HTMLInputElement | null;
    const imagePreview = document.getElementById(previewId) as HTMLImageElement | null;
    const placeholderIcon = document.getElementById(iconId) as HTMLElement | null;
    const removeBtn = document.getElementById(removeBtnId) as HTMLButtonElement | null;
